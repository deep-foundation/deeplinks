...
const sql_1 = require("@deep-foundation/hasura/sql");
const debug_1 = __importDefault(require("debug"));
const debug = (0, debug_1.default)('deeplinks:tests:sync-handlers');
...
describe('sync handlers', () => {
    describe('Prepare fuction', () => {
        it(`handleInsert`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield exports.api.sql((0, sql_1.sql) `select links__sync__handler__prepare__function('${link}'::jsonb, ${handlerId}::bigint)`);
    ...
    describe('DeepClient mini', () => {
        it(`id`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'id', '["@deep-foundation/core", "Rule"]'::jsonb, '{}'::jsonb)`);
            ...
            chai_1.assert.equal((_g = JSON.parse((_f = (_e = (_d = result === null || result === void 0 ? void 0 : result.data) === null || _d === void 0 ? void 0 : _d.result) === null || _e === void 0 ? void 0 : _e[1]) === null || _f === void 0 ? void 0 : _f[0])) === null || _g === void 0 ? void 0 : _g[0], clientResult);
        }));
        it(`select should return value`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'select', '{"id": ${id}}'::jsonb, '{}'::jsonb)`);
            ...
            chai_1.assert.equal(value === null || value === void 0 ? void 0 : value.value, 'HelloBugFixers');
            chai_1.assert.equal(value === null || value === void 0 ? void 0 : value.id, (_v = (_u = (_t = selected === null || selected === void 0 ? void 0 : selected.data) === null || _t === void 0 ? void 0 : _t[0]) === null || _u === void 0 ? void 0 : _u.value) === null || _v === void 0 ? void 0 : _v.id);
        }));
        describe('permissions', () => {
            describe('select', () => {
                it(`root can select from tree`, () => __awaiter(void 0, void 0, void 0, function* () {
                    var _a, _b;
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'select', '{"link_id":1}'::jsonb, '{"table":"tree"}'::jsonb)`);
                    ...
                    chai_1.assert.equal(!!JSON.parse(n1 === null || n1 === void 0 ? void 0 : n1[0]).data.length, true);
                }));
                it(`root can select from can`, () => __awaiter(void 0, void 0, void 0, function* () {
                    var _c, _d;
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'select', '{"subject_id":${yield deep.id('deep', 'admin')}}'::jsonb, '{"table":"can"}'::jsonb)`);
                ...
                it(`root can select from selectors`, () => __awaiter(void 0, void 0, void 0, function* () {
                    var _e, _f;
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'select', '{"item_id":213}'::jsonb, '{"table":"selectors"}'::jsonb)`);
                ...
                it(`nobody can select from not permitted tables`, () => __awaiter(void 0, void 0, void 0, function* () {
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'select', '{"id":1}'::jsonb, '{"table":"strings"}'::jsonb)`);
                    chai_1.assert.equal(result.error, 'Bad Request');
                }));
                it(`user contain range`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    log('id', id);
                    const result1 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'select', '{"id": ${id}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n1 === null || n1 === void 0 ? void 0 : n1[0]).data, 1, `item_id ${id} must be selectable by ${a1.linkId}`);
                    log(`${a1.linkId} n1`, n1);
                    const result2 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a2.linkId}::bigint, 'select', '{"id": ${id}}'::jsonb, '{}'::jsonb)`);
                    ...
                    log(`${a2.linkId} n2`, n2);
                    chai_1.assert.lengthOf(JSON.parse(n2 === null || n2 === void 0 ? void 0 : n2[0]).data, 0, `item_id ${id} must not be selectable by ${a2.linkId}`);
                    const result3 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'select', '{"id": ${id}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n3 === null || n3 === void 0 ? void 0 : n3[0]).data, 1, `item_id ${id} must be selectable by admin`);
                }));
                it(`rule select include 1 depth but exclude 2 depth`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const result1 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'select', '{"id": ${id1}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n1 === null || n1 === void 0 ? void 0 : n1[0]).data, 1);
                    const result2 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a2.linkId}::bigint, 'select', '{"id": ${id1}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n2 === null || n2 === void 0 ? void 0 : n2[0]).data, 1);
                    const result3 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a3.linkId}::bigint, 'select', '{"id": ${id1}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n3 === null || n3 === void 0 ? void 0 : n3[0]).data, 0);
                    const result4 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'select', '{"id": ${id1}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n4 === null || n4 === void 0 ? void 0 : n4[0]).data, 1);
                    const result5 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'select', '{"id": ${id2}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n5 === null || n5 === void 0 ? void 0 : n5[0]).data, 1);
                    const result6 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a2.linkId}::bigint, 'select', '{"id": ${id2}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n6 === null || n6 === void 0 ? void 0 : n6[0]).data, 0);
                    const result7 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a3.linkId}::bigint, 'select', '{"id": ${id2}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n7 === null || n7 === void 0 ? void 0 : n7[0]).data, 0);
                    const result8 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'select', '{"id": ${id2}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(JSON.parse(n8 === null || n8 === void 0 ? void 0 : n8[0]).data, 1);
                }));
            });
            describe('insert', () => {
                it(`root can insert`, () => __awaiter(void 0, void 0, void 0, function* () {
                    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'insert', '{"type_id":${yield deep.id('@deep-foundation/core', 'Operation')}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.equal(customLinkId, (_k = (_j = clientResult === null || clientResult === void 0 ? void 0 : clientResult.data) === null || _j === void 0 ? void 0 : _j[0]) === null || _k === void 0 ? void 0 : _k.id);
                }));
                it(`guest cant insert by default`, () => __awaiter(void 0, void 0, void 0, function* () {
                    const a1 = yield deep.guest({});
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'insert', '{"type_id":${yield deep.id('@deep-foundation/core', 'Operation')}}'::jsonb, '{}'::jsonb)`);
                    chai_1.assert.isNotEmpty(result === null || result === void 0 ? void 0 : result.error);
                }));
                it(`insert permission can be gived to guest`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const r1 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'insert', '{"type_id":${yield deep.id('@deep-foundation/core', 'Operation')}}'::jsonb, '{}'::jsonb)`);
                    ...
                    if (e1)
                        log('error', e1);
                    (0, chai_1.expect)(da1).to.not.be.undefined;
                    chai_1.assert.equal(!!e1, false);
                    const r2 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a2.linkId}::bigint, 'insert', '{"type_id":${yield deep.id('@deep-foundation/core', 'Operation')}}'::jsonb, '{}'::jsonb)`);
                    ...
                    (0, chai_1.expect)(da2).to.not.be.undefined;
                    chai_1.assert.equal(!!e2, false);
                    const r3 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a3.linkId}::bigint, 'insert', '{"type_id":${yield deep.id('@deep-foundation/core', 'Operation')}}'::jsonb, '{}'::jsonb)`);
                    ...
                    log('da3', da3);
                    (0, chai_1.expect)(e3).to.not.be.undefined;
                }));
                it(`insert permission with SelectorFilter`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    (0, chai_1.expect)(da1).to.not.be.undefined;
                    chai_1.assert.equal(!!e1, false);
                    const r2 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'insert', '{"type_id":${TempType}, "from_id": ${(_8 = da1 === null || da1 === void 0 ? void 0 : da1[0]) === null || _8 === void 0 ? void 0 : _8.id}, "to_id": ${a1.linkId}}'::jsonb, '{}'::jsonb)`);
                    ...
                    (0, chai_1.expect)(da1t).to.not.be.undefined;
                    chai_1.assert.equal(!!e1t, false);
                    const r3 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a2.linkId}::bigint, 'insert', '{"type_id":${yield deep.id('@deep-foundation/core', 'Operation')}}'::jsonb, '{}'::jsonb)`);
                    ...
                    let r4;
                    try {
                        r4 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a2.linkId}::bigint, 'insert', '{"type_id":${TempType}, "from_id": ${(_17 = da2 === null || da2 === void 0 ? void 0 : da2[0]) === null || _17 === void 0 ? void 0 : _17.id}, "to_id": ${a1.linkId}}'::jsonb, '{}'::jsonb)`);
                    }
                    catch (e) {
                        log(e);
                    }
                    ...
                    (0, chai_1.expect)(da2t).to.be.undefined;
                    (0, chai_1.expect)(e2t).to.not.be.undefined;
                    const r5 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a3.linkId}::bigint, 'insert', '{"type_id":${yield deep.id('@deep-foundation/core', 'Operation')}}'::jsonb, '{}'::jsonb)`);
                    ...
                    (0, chai_1.expect)(da3).to.not.be.undefined;
                    chai_1.assert.equal(!!e3, false);
                    const r6 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a3.linkId}::bigint, 'insert', '{"type_id":${TempType}, "from_id": ${(_29 = da2 === null || da2 === void 0 ? void 0 : da2[0]) === null || _29 === void 0 ? void 0 : _29.id}, "to_id": ${a3.linkId}}'::jsonb, '{}'::jsonb)`);
                    ...
                    (0, chai_1.expect)(da4).to.not.be.undefined;
                    chai_1.assert.equal(!!e4, false);
                }));
            });
            describe('update', () => {
                describe('values', () => {
                    it(`root can update value`, () => __awaiter(void 0, void 0, void 0, function* () {
                        ...
                        chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1);
                        yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'update', '[{"link_id":${id}}, { "value": "test2"}, { "table": "strings"}]'::jsonb, '{}'::jsonb)`);
                        const clientResult = yield deep.select({ id: { _eq: id } });
                        log('clientResult', clientResult);
                        chai_1.assert.equal(undefined, (_c = (_b = (_a = clientResult === null || clientResult === void 0 ? void 0 : clientResult.data) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.value) === null || _c === void 0 ? void 0 : _c.value);
                        const n2 = yield deep.insert({ link_id: id, value: 'test1' }, { table: 'strings' });
                        log('n2', n2);
                        const inserted = yield deep.select({ id: { _eq: id } });
                        log('inserted', inserted);
                        chai_1.assert.equal('test1', (_f = (_e = (_d = inserted === null || inserted === void 0 ? void 0 : inserted.data) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.value) === null || _f === void 0 ? void 0 : _f.value);
                        yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'update', '[{"link_id":${id}}, { "value": "test2"}, { "table": "strings"}]'::jsonb, '{}'::jsonb)`);
                        const clientResult2 = yield deep.select({ id: { _eq: id } });
                        log('clientResult2', clientResult2);
                        chai_1.assert.equal('test2', (_j = (_h = (_g = clientResult2 === null || clientResult2 === void 0 ? void 0 : clientResult2.data) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.value) === null || _j === void 0 ? void 0 : _j.value);
            ...
            describe('delete', () => {
                it(`root can delete`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const n1 = yield deep.select({ id });
                    chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1);
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'delete', '{"id":${id}}'::jsonb, '{}'::jsonb)`);
                    const customLinkId = (_f = (_e = (_d = JSON.parse((_c = (_b = (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.result) === null || _b === void 0 ? void 0 : _b[1]) === null || _c === void 0 ? void 0 : _c[0])) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.id;
                    log('customLinkId', customLinkId);
                    const clientResult = yield deep.select({ id: { _eq: customLinkId } });
                    log('clientResult', clientResult);
                    ...
                    chai_1.assert.lengthOf(clientResult === null || clientResult === void 0 ? void 0 : clientResult.data, 0);
                }));
                it(`nobody can delete from not permitted tables`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const n1 = yield deep.select({ id });
                    chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1);
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${yield deep.id('deep', 'admin')}::bigint, 'delete', '{"id":${id}}'::jsonb, '{"table":"selectors"}'::jsonb)`);
                ...
                it(`guest cant delete by default`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1);
                    const a1 = yield deep.guest({});
                    const result = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'delete', '{"id":${id}}'::jsonb, '{}'::jsonb)`);
                    if ((_l = (_k = (_j = result === null || result === void 0 ? void 0 : result.data) === null || _j === void 0 ? void 0 : _j.result) === null || _k === void 0 ? void 0 : _k[1]) === null || _l === void 0 ? void 0 : _l[0])
                        chai_1.assert.lengthOf((_q = JSON.parse((_p = (_o = (_m = result === null || result === void 0 ? void 0 : result.data) === null || _m === void 0 ? void 0 : _m.result) === null || _o === void 0 ? void 0 : _o[1]) === null || _p === void 0 ? void 0 : _p[0])) === null || _q === void 0 ? void 0 : _q.data, 0);
                    const n2 = yield deep.select({ id });
                    chai_1.assert.lengthOf(n2 === null || n2 === void 0 ? void 0 : n2.data, 1);
                }));
                it(`delete permission can be gived to guest`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const r1 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'delete', '{"id":${id1}}'::jsonb, '{}'::jsonb)`);
                    const r2 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a2.linkId}::bigint, 'delete', '{"id":${id2}}'::jsonb, '{}'::jsonb)`);
                    const r3 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a3.linkId}::bigint, 'delete', '{"id":${id3}}'::jsonb, '{}'::jsonb)`);
                    ...
                    chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 0);
                    ...
                    chai_1.assert.lengthOf(n2 === null || n2 === void 0 ? void 0 : n2.data, 0);
                    ...
                    (0, chai_1.expect)(da3).to.be.undefined;
                    const n3 = yield deep.select({ id: id3 });
                    chai_1.assert.lengthOf(n3 === null || n3 === void 0 ? void 0 : n3.data, 1);
                ...
                it(`delete permission with SelectorFilter`, () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    yield delay(5000);
                    const d1 = new client_2.DeepClient(Object.assign(Object.assign({ deep }, a1), { silent: true }));
                    const { data: da1, error: e1 } = yield d1.insert({
                        type_id: yield deep.id('@deep-foundation/core', 'Operation'),
                        string: { data: { value: 'abc1' } },
                    });
                    chai_1.assert.equal(!!e1, false);
                    const r1 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a1.linkId}::bigint, 'delete', '{"id":${(_6 = da1 === null || da1 === void 0 ? void 0 : da1[0]) === null || _6 === void 0 ? void 0 : _6.id}}'::jsonb, '{}'::jsonb)`);
                    const e1d = r1.error;
                    (0, chai_1.expect)(e1d).to.not.be.undefined;
                    if ((_9 = (_8 = (_7 = r1 === null || r1 === void 0 ? void 0 : r1.data) === null || _7 === void 0 ? void 0 : _7.result) === null || _8 === void 0 ? void 0 : _8[1]) === null || _9 === void 0 ? void 0 : _9[0])
                        chai_1.assert.lengthOf((_13 = JSON.parse((_12 = (_11 = (_10 = r1 === null || r1 === void 0 ? void 0 : r1.data) === null || _10 === void 0 ? void 0 : _10.result) === null || _11 === void 0 ? void 0 : _11[1]) === null || _12 === void 0 ? void 0 : _12[0])) === null || _13 === void 0 ? void 0 : _13.data, 0);
                    const n1 = yield deep.select((_14 = da1 === null || da1 === void 0 ? void 0 : da1[0]) === null || _14 === void 0 ? void 0 : _14.id);
                    chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1);
                    const d2 = new client_2.DeepClient(Object.assign(Object.assign({ deep }, a2), { silent: true }));
                    const { data: da2, error: e2 } = yield d2.insert({
                        type_id: yield deep.id('@deep-foundation/core', 'Operation'),
                        string: { data: { value: 'abc2' } },
                    });
                    chai_1.assert.equal(!!e2, false);
                    const r2 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a2.linkId}::bigint, 'delete', '{"id":${(_15 = da2 === null || da2 === void 0 ? void 0 : da2[0]) === null || _15 === void 0 ? void 0 : _15.id}}'::jsonb, '{}'::jsonb)`);
                    const e2d = r2.error;
                    chai_1.assert.equal(!!e2d, false);
                    if ((_18 = (_17 = (_16 = r2 === null || r2 === void 0 ? void 0 : r2.data) === null || _16 === void 0 ? void 0 : _16.result) === null || _17 === void 0 ? void 0 : _17[1]) === null || _18 === void 0 ? void 0 : _18[0])
                        chai_1.assert.lengthOf((_22 = JSON.parse((_21 = (_20 = (_19 = r2 === null || r2 === void 0 ? void 0 : r2.data) === null || _19 === void 0 ? void 0 : _19.result) === null || _20 === void 0 ? void 0 : _20[1]) === null || _21 === void 0 ? void 0 : _21[0])) === null || _22 === void 0 ? void 0 : _22.data, 1);
                    const n2 = yield deep.select((_23 = da2 === null || da2 === void 0 ? void 0 : da2[0]) === null || _23 === void 0 ? void 0 : _23.id);
                    chai_1.assert.lengthOf(n2 === null || n2 === void 0 ? void 0 : n2.data, 0);
                    const d3 = new client_2.DeepClient(Object.assign(Object.assign({ deep }, a3), { silent: true }));
                    const { data: da3, error: e3 } = yield d3.insert({
                        type_id: yield deep.id('@deep-foundation/core', 'Operation'),
                        string: { data: { value: 'abc3' } },
                    });
                    chai_1.assert.equal(!!e3, false);
                    const r3 = yield exports.api.sql((0, sql_1.sql) `select links__deep__client(${a3.linkId}::bigint, 'delete', '{"id":${(_24 = da3 === null || da3 === void 0 ? void 0 : da3[0]) === null || _24 === void 0 ? void 0 : _24.id}}'::jsonb, '{}'::jsonb)`);
                    const e3d = r3.error;
                    (0, chai_1.expect)(e3d).to.not.be.undefined;
                    if ((_27 = (_26 = (_25 = r3 === null || r3 === void 0 ? void 0 : r3.data) === null || _25 === void 0 ? void 0 : _25.result) === null || _26 === void 0 ? void 0 : _26[1]) === null || _27 === void 0 ? void 0 : _27[0])
                        chai_1.assert.lengthOf((_31 = JSON.parse((_30 = (_29 = (_28 = r3 === null || r3 === void 0 ? void 0 : r3.data) === null || _28 === void 0 ? void 0 : _28.result) === null || _29 === void 0 ? void 0 : _29[1]) === null || _30 === void 0 ? void 0 : _30[0])) === null || _31 === void 0 ? void 0 : _31.data, 0);
    ...
    describe('Handle operations', () => {
        describe('Handle insert', () => {
            it(`Handle insert on type`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const handler = yield (0, handlers_1.insertHandler)(handleInsertTypeId, typeId, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); }`, undefined, supportsId);
                ...
                debug('delete handler', yield (0, handlers_1.deleteHandler)(handler));
                chai_1.assert.equal(!!((_m = (_l = insertedByHandler === null || insertedByHandler === void 0 ? void 0 : insertedByHandler.data) === null || _l === void 0 ? void 0 : _l[0]) === null || _m === void 0 ? void 0 : _m.id), true);
            }));
            it.skip(`Handle insert on type with sql injection (DAMAGES DATABASE SHOULD BE SKIPPED UNTIL FIXED)`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                debug('customLinkId', customLinkId);
                const handler = yield (0, handlers_1.insertHandler)(handleInsertTypeId, typeId, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: "${customLinkId}) RETURNING id; DROP TABLE promise_links; INSERT INTO links (type_id, from_id, to_id) VALUES (${customLinkId}, ${customLinkId}, ${customLinkId}) RETURNING id; -- ", from_id: ${customLinkId}}); }`, undefined, supportsId);
                debug('handler', handler);
                try {
                ...
                yield deep.delete(customLinkId);
                debug('delete handler', yield (0, handlers_1.deleteHandler)(handler));
                chai_1.assert.equal(!!((_z = (_y = insertedByHandler === null || insertedByHandler === void 0 ? void 0 : insertedByHandler.data) === null || _y === void 0 ? void 0 : _y[0]) === null || _z === void 0 ? void 0 : _z.id), true);
            }));
            it(`Handle insert 2 triggers and broke transaction in second`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                debug('handler', handler);
                debug('customLinkId', customLinkId);
                const handler2 = yield (0, handlers_1.insertHandler)(handleInsertTypeId, typeId, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); throw new Error('errorTest')}`, undefined, supportsId);
                try {
                ...
                yield deep.delete(customLinkId);
                debug('delete handler', yield (0, handlers_1.deleteHandler)(handler));
                debug('delete handler2', yield (0, handlers_1.deleteHandler)(handler2));
                chai_1.assert.equal((_11 = (_10 = insertedByHandler === null || insertedByHandler === void 0 ? void 0 : insertedByHandler.data) === null || _10 === void 0 ? void 0 : _10[0]) === null || _11 === void 0 ? void 0 : _11.id, undefined);
            }));
            it(`Handle insert 1 trigger and 2 types, check not triggered twice`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const handler = yield (0, handlers_1.insertHandler)(handleInsertTypeId, customLinkId2, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); }`, undefined, supportsId);
                debug('handler', handler);
                try {
                ...
                const insertedByHandler = yield deep.select({ type_id: { _eq: customLinkId }, to_id: { _eq: customLinkId }, from_id: { _eq: customLinkId } });
                chai_1.assert.equal((_18 = insertedByHandler === null || insertedByHandler === void 0 ? void 0 : insertedByHandler.data) === null || _18 === void 0 ? void 0 : _18.length, 1);
                ...
                chai_1.assert.equal((_21 = insertedByHandler2 === null || insertedByHandler2 === void 0 ? void 0 : insertedByHandler2.data) === null || _21 === void 0 ? void 0 : _21.length, 2);
            ...
            it(`Handle insert on type throw error`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const handler = yield (0, handlers_1.insertHandler)(handleInsertTypeId, typeId, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); throw new Error('testError');}`, undefined, supportsId);
                let linkId;
                let error;
                debug('handler', handler);
                try {
                ...
                debug('delete handler', JSON.stringify(yield (0, handlers_1.deleteHandler)(handler)));
                ...
                chai_1.assert.equal(error, 'testError');
            }));
            it(`Handle insert on selector`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const handler = yield (0, handlers_1.insertHandler)(handleInsertTypeId, selectorId, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); }`, undefined, supportsId);
                let selectorItem;
                debug('handler', handler);
                try {
                    selectorItem = yield (0, handlers_1.insertSelectorItem)({ selectorId, nodeTypeId, linkTypeId, treeId, rootId });
                ...
                chai_1.assert.equal(!!((_45 = (_44 = insertedByHandler === null || insertedByHandler === void 0 ? void 0 : insertedByHandler.data) === null || _44 === void 0 ? void 0 : _44[0]) === null || _45 === void 0 ? void 0 : _45.id), true);
            }));
        });
        describe('Handle delete', () => {
            it(`Handle delete on type`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const inserted = yield deep.insert({ type_id: 1, from_id: anyTypeId, to_id: anyTypeId });
                const customLinkId = (_b = (_a = inserted === null || inserted === void 0 ? void 0 : inserted.data) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.id;
                const handler = yield (0, handlers_1.insertHandler)(handleDeleteTypeId, typeId, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); }`, undefined, supportsId);
                debug('handler', handler);
                debug('customLinkId', customLinkId);
                const linkId = (_d = (_c = (yield deep.insert({ type_id: typeId }))) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d[0].id;
                try {
                ...
                debug('delete handler', yield (0, handlers_1.deleteHandler)(handler));
                yield deep.delete(customLinkId);
                chai_1.assert.equal(!!((_k = (_j = insertedByHandler === null || insertedByHandler === void 0 ? void 0 : insertedByHandler.data) === null || _j === void 0 ? void 0 : _j[0]) === null || _k === void 0 ? void 0 : _k.id), true);
            }));
            it(`Handle delete on selector`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const handler = yield (0, handlers_1.insertHandler)(handleDeleteTypeId, selectorId, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); }`, undefined, supportsId);
                const selectorItem = yield (0, handlers_1.insertSelectorItem)({ selectorId, nodeTypeId, linkTypeId, treeId, rootId });
                debug('handler', handler);
                try {
                ...
                debug('deleteHandler');
                yield (0, handlers_1.deleteHandler)(handler);
                chai_1.assert.equal(!!((_t = (_s = insertedByHandler === null || insertedByHandler === void 0 ? void 0 : insertedByHandler.data) === null || _s === void 0 ? void 0 : _s[0]) === null || _t === void 0 ? void 0 : _t.id), true);
            }));
        });
        describe('Handle value', () => {
            describe('Handle strings', () => {
                it('Handle insert string', () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const customLinkId = (_b = (_a = inserted === null || inserted === void 0 ? void 0 : inserted.data) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.id;
                    debug('customLinkId', customLinkId);
                    const handler = yield (0, handlers_1.insertHandler)(handleUpdateId, typeId, `({deep, data}) => { deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); }`, undefined, supportsId);
                    debug('handler', handler);
                    try {
                ...
                it('Handle update string', () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const customLinkId = (_p = (_o = inserted === null || inserted === void 0 ? void 0 : inserted.data) === null || _o === void 0 ? void 0 : _o[0]) === null || _p === void 0 ? void 0 : _p.id;
                    debug('customLinkId', customLinkId);
                    const handler = yield (0, handlers_1.insertHandler)(handleUpdateId, typeId, `({deep, data}) => { if (data?.oldLink?.value) deep.insert({type_id: ${customLinkId}, to_id: ${customLinkId}, from_id: ${customLinkId}}); }`, undefined, supportsId);
                    debug('handler', handler);
                    try {
                ...
                it('Handle delete string', () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    yield deep.delete(customLinkId);
                    debug('delete handler', yield (0, handlers_1.deleteHandler)(handler));
                    chai_1.assert.equal(!!((_11 = (_10 = insertedByHandler === null || insertedByHandler === void 0 ? void 0 : insertedByHandler.data) === null || _10 === void 0 ? void 0 : _10[0]) === null || _11 === void 0 ? void 0 : _11.id), true);
                }));
            });
