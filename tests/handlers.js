...
const deletePackageWithPermissions = (deepPackage) => __awaiter(void 0, void 0, void 0, function* () {
    yield deep.delete(_.compact(_.concat([deepPackage.typeId, deepPackage.containId, deepPackage.packageId], deepPackage.ruleIds)));
    yield deep.delete(_.compact([deepPackage.containValueId, deepPackage.packageValueId]), { table: 'strings' });
});
...
export function deletePromiseResult(promiseResult, linkId) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield deep.delete(_.compact([resultLinkId, thenLinkId, promiseResultId, promiseId, linkId]));
    });
}
export const deleteScheduleHandler = (handler) => __awaiter(void 0, void 0, void 0, function* () {
...
export function getPromiseResults(deep, resultTypeId, linkId) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
...
describe('Async handlers', () => {
    describe('sync function handle by type with resolve', () => {
        it(`handle insert`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const handler = yield insertHandler(handleInsertTypeId, typeId, `(arg) => {console.log(arg); return {result: ${numberToReturn}}}`);
        ...
        it(`handle update when value is inserted`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const handler = yield insertHandler(handleUpdateTypeId, typeId, `(arg) => {console.log(arg); return {result: ${numberToReturn}}}`);
        ...
        it(`handle delete`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const handler = yield insertHandler(handleDeleteTypeId, typeId, `(arg) => {console.log(arg); return {result: ${numberToReturn}}}`);
    ...
    describe('sync function handle by type with reject', () => {
        it(`handle insert`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const typeId = yield deep.id('@deep-foundation/core', 'Type');
            const handleInsertTypeId = yield deep.id('@deep-foundation/core', 'HandleInsert');
            const handler = yield insertHandler(handleInsertTypeId, typeId, `({deep, data}) => { 
        ...
        it(`handle delete`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const typeId = yield deep.id('@deep-foundation/core', 'Type');
            const handleDeleteTypeId = yield deep.id('@deep-foundation/core', 'HandleDelete');
            const handler = yield insertHandler(handleDeleteTypeId, typeId, `(arg) => { throw ${numberToThrow}; return { "error": "return is not possible" }; }`);
            const linkId = (_d = (_c = (yield deep.insert({ type_id: typeId }))) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d[0].id;
            yield deep.delete(linkId);
            yield deep.await(linkId);
            const rejectedTypeId = yield deep.id('@deep-foundation/core', 'Rejected');
    ...
    describe('async function handle by type with reject', () => {
        it(`handle insert`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const typeId = yield deep.id('@deep-foundation/core', 'Type');
            const handleInsertTypeId = yield deep.id('@deep-foundation/core', 'HandleInsert');
            const handler = yield insertHandler(handleInsertTypeId, typeId, `async (arg) => { throw ${numberToThrow}; return { "error": "return is not possible" }; }`);
            const linkId = (_b = (_a = (yield deep.insert({ type_id: typeId }))) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b[0].id;
            yield deep.await(linkId);
            const rejectedTypeId = yield deep.id('@deep-foundation/core', 'Rejected');
            const promiseResults = yield getPromiseResults(deep, rejectedTypeId, linkId);
        ...
        it(`handle update`, () => __awaiter(void 0, void 0, void 0, function* () {
            var _c, _d;
            const numberToThrow = nextHandlerResult();
            const typeId = yield deep.id('@deep-foundation/core', 'Type');
            const handleUpdateTypeId = yield deep.id('@deep-foundation/core', 'HandleUpdate');
            const handler = yield insertHandler(handleUpdateTypeId, typeId, `async (arg) => { throw ${numberToThrow}; return { "error": "return is not possible" }; }`);
            ...
            yield deep.update(linkId, { to_id: yield deep.id('@deep-foundation/core', 'Any') });
            yield deep.await(linkId);
            const rejectedTypeId = yield deep.id('@deep-foundation/core', 'Rejected');
            const promiseResults = yield getPromiseResults(deep, rejectedTypeId, linkId);
            const promiseResult = promiseResults.find(link => { var _a; return ((_a = link.object) === null || _a === void 0 ? void 0 : _a.value) === numberToThrow; });
        ...
        it(`handle delete`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const typeId = yield deep.id('@deep-foundation/core', 'Type');
            const handleDeleteTypeId = yield deep.id('@deep-foundation/core', 'HandleDelete');
            const handler = yield insertHandler(handleDeleteTypeId, typeId, `async (arg) => { throw ${numberToThrow}; return { "error": "return is not possible" }; }`);
            const linkId = (_f = (_e = (yield deep.insert({ type_id: typeId }))) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f[0].id;
            yield deep.delete(linkId);
            yield deep.await(linkId);
            const rejectedTypeId = yield deep.id('@deep-foundation/core', 'Rejected');
    ...
    describe('sync function handle by schedule with resolve', () => {
        it(`handle schedule`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield deleteScheduleHandler(handler);
            assert.isTrue(!!promiseResult);
        }));
    });
    describe('async function handle by type with resolve using deep client', () => {
        it(`handle insert`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const handler = yield insertHandler(handleInsertTypeId, typeId, `async (arg) => {
        const deep = arg.deep;
    ...
    describe('handle port', () => {
        it(`handle port`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield waitOn({ resources: [`http://localhost:${port}/healthz`] });
            log("container is up");
    ...
    describe('handle route', () => {
        it(`handle route`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield waitOn({ resources: [url], reverse: true });
        ...
        `,
            ...
            log("route handler is up");
            yield delay(5000);
            const { data } = yield apolloClient.query({ query: gql `{ ${field} }` });
            assert.equal(data === null || data === void 0 ? void 0 : data.constant, 42);
            ...
            yield deep.delete(portLink === null || portLink === void 0 ? void 0 : portLink.id);
            log("waiting for route to be deleted");
            yield waitOn({ resources: [waitOnUrl], reverse: true });
            log("route handler is down");
        }));
    });
    describe('handle by selector', () => {
        it(`handle insert`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const handler = yield insertHandler(handleInsertTypeId, selectorId, `(arg) => {console.log(arg); return {result: ${numberToReturn}}}`);
            const selectorItems = yield insertSelectorItems({ selectorId, nodeTypeId, linkTypeId, treeId, rootId });
        ...
        it(`handle delete`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const selector = yield insertSelector();
            const { nodeTypeId, linkTypeId, treeId, treeIncludesIds, selectorId, selectorIncludeId, selectorTreeId, rootId } = selector;
            const handler = yield insertHandler(handleDeleteTypeId, selectorId, `(arg) => {console.log(arg); return {result: ${numberToReturn}}}`);
            const selectorItems = yield insertSelectorItems({ selectorId, nodeTypeId, linkTypeId, treeId, rootId });
        ...
        it(`handle update when value is updated`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const selector = yield insertSelector();
            const { nodeTypeId, linkTypeId, treeId, treeIncludesIds, selectorId, selectorIncludeId, selectorTreeId, rootId } = selector;
            const handler = yield insertHandler(handleUpdateTypeId, selectorId, `(arg) => {console.log(arg); return {result: ${numberToReturn}}}`);
            const selectorItems = yield insertSelectorItems({ selectorId, nodeTypeId, linkTypeId, treeId, rootId });
