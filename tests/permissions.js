...
beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    admin = new client_2.DeepClient({ deep, token, linkId });
}));
let deep = root;
describe('permissions', () => {
    describe('select', () => {
        it(`user contain range`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const d1 = new client_2.DeepClient(Object.assign({ deep }, a1));
            const d2 = new client_2.DeepClient(Object.assign({ deep }, a2));
            ...
            chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1, `item_id ${id} must be selectable by ${a1.linkId}`);
            const n2 = yield d2.select({ id });
            chai_1.assert.lengthOf(n2 === null || n2 === void 0 ? void 0 : n2.data, 0, `item_id ${id} must not be selectable by ${a2.linkId}`);
            const n3 = yield admin.select({ id });
            chai_1.assert.lengthOf(n3 === null || n3 === void 0 ? void 0 : n3.data, 1, `item_id ${id} must be selectable by ${admin.linkId}`);
        }));
        it(`rule select include 1 depth but exclude 2 depth`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const d1 = new client_2.DeepClient(Object.assign({ deep }, a1));
            const d2 = new client_2.DeepClient(Object.assign({ deep }, a2));
            const d3 = new client_2.DeepClient(Object.assign({ deep }, a3));
            ...
            chai_1.assert.lengthOf(n3 === null || n3 === void 0 ? void 0 : n3.data, 0);
            const n4 = yield admin.select({ id: id1 });
            chai_1.assert.lengthOf(n4 === null || n4 === void 0 ? void 0 : n4.data, 1);
            const n5 = yield d1.select({ id: id2 });
            chai_1.assert.lengthOf(n5 === null || n5 === void 0 ? void 0 : n5.data, 1);
            const n6 = yield d2.select({ id: id2 });
            chai_1.assert.lengthOf(n6 === null || n6 === void 0 ? void 0 : n6.data, 0);
            const n7 = yield d3.select({ id: id2 });
            chai_1.assert.lengthOf(n7 === null || n7 === void 0 ? void 0 : n7.data, 0);
            const n8 = yield admin.select({ id: id2 });
            chai_1.assert.lengthOf(n8 === null || n8 === void 0 ? void 0 : n8.data, 1);
        }));
    });
    describe('insert', () => {
        ...
        it(`guest cant insert by default`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            chai_1.assert.isNotEmpty(error);
        }));
        it(`insert permission can be gived to guest`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(e1).to.be.undefined;
            ...
            (0, chai_1.expect)(e2).to.be.undefined;
        ...
        it(`insert permission with SelectorFilter`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(e1t).to.be.undefined;
            const d2 = new client_2.DeepClient(Object.assign(Object.assign({ deep }, a2), { silent: true }));
            const { data: da2, error: e2 } = yield d2.insert({
                type_id: yield deep.id('@deep-foundation/core', 'Operation'),
            });
    ...
    describe('update', () => {
        it(`root can update string value`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const n1 = yield deep.select({ id });
            chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1);
            chai_1.assert.equal((_c = (_b = (_a = n1 === null || n1 === void 0 ? void 0 : n1.data) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.value) === null || _c === void 0 ? void 0 : _c.value, 'def');
        }));
        it(`guest cant update string value`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            chai_1.assert.lengthOf(updated, 0);
            const n1 = yield deep.select({ id });
            chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1);
            chai_1.assert.equal((_f = (_e = (_d = n1 === null || n1 === void 0 ? void 0 : n1.data) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.value) === null || _f === void 0 ? void 0 : _f.value, 'abc');
        }));
        it(`update permission can be gived to guest`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            chai_1.assert.lengthOf(u1, 1);
            const n1 = yield deep.select({ id });
            chai_1.assert.equal((_j = (_h = (_g = n1 === null || n1 === void 0 ? void 0 : n1.data) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.value) === null || _j === void 0 ? void 0 : _j.value, 'def');
            const d2 = new client_2.DeepClient(Object.assign({ deep }, a2));
            const { data: u2 } = yield d2.update({ link_id: id }, {
                value: 'efg',
            }, { table: 'strings' });
            chai_1.assert.lengthOf(u2, 1);
            const n2 = yield deep.select({ id });
            chai_1.assert.equal((_m = (_l = (_k = n2 === null || n2 === void 0 ? void 0 : n2.data) === null || _k === void 0 ? void 0 : _k[0]) === null || _l === void 0 ? void 0 : _l.value) === null || _m === void 0 ? void 0 : _m.value, 'efg');
            const d3 = new client_2.DeepClient(Object.assign({ deep }, a3));
            const { data: u3 } = yield d3.update({ link_id: id }, {
                value: 'fgj',
            }, { table: 'strings' });
            chai_1.assert.lengthOf(u3, 0);
            const n3 = yield deep.select({ id });
            chai_1.assert.equal((_q = (_p = (_o = n3 === null || n3 === void 0 ? void 0 : n3.data) === null || _o === void 0 ? void 0 : _o[0]) === null || _p === void 0 ? void 0 : _p.value) === null || _q === void 0 ? void 0 : _q.value, 'efg');
        }));
    });
    describe('delete', () => {
        it(`root can delete`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            chai_1.assert.lengthOf(deleted, 1);
            const n2 = yield deep.select({ id });
        ...
        it(`guest cant delete by default`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            chai_1.assert.lengthOf(deleted, 0);
            const n2 = yield deep.select({ id });
        }));
        ...
        it(`delete permission with SelectorFilter`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(da1d).to.be.undefined;
            const d2 = new client_2.DeepClient(Object.assign(Object.assign({ deep }, a2), { silent: true }));
            const { data: da2, error: e2 } = yield d2.insert({
                type_id: yield deep.id('@deep-foundation/core', 'Operation'),
            ...
            (0, chai_1.expect)(e2d).to.be.undefined;
            (0, chai_1.expect)(da2d).to.not.be.undefined;
            const d3 = new client_2.DeepClient(Object.assign(Object.assign({ deep }, a3), { silent: true }));
            const { data: da3, error: e3 } = yield d3.insert({
                type_id: yield deep.id('@deep-foundation/core', 'Operation'),
            ...
            (0, chai_1.expect)(da3d).to.be.undefined;
        }));
    });
    describe('login', () => {
