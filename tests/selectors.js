...
describe('selectors', () => {
    it(`selector include exclude`, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_1.assert.lengthOf(n1 === null || n1 === void 0 ? void 0 : n1.data, 1, `item_id ${id2} must be in selector_id ${s1}`);
        const n2 = yield deep.select({
            item_id: { _eq: id3 }, selector_id: { _eq: s1 },
        }, { table: 'selectors', returning: 'item_id selector_id' });
        chai_1.assert.lengthOf(n2 === null || n2 === void 0 ? void 0 : n2.data, 0, `item_id ${id3} must not be in selector_id ${s1}`);
        const n3 = yield deep.select({
            item_id: { _eq: id4 }, selector_id: { _eq: s1 },
        }, { table: 'selectors', returning: 'item_id selector_id' });
        chai_1.assert.lengthOf(n3 === null || n3 === void 0 ? void 0 : n3.data, 0, `item_id ${id4} must not be in selector_id ${s1}`);
        const n4 = yield deep.select({
            item_id: { _eq: id5 }, selector_id: { _eq: s1 },
        }, { table: 'selectors', returning: 'item_id selector_id' });
        chai_1.assert.lengthOf(n4 === null || n4 === void 0 ? void 0 : n4.data, 0, `item_id ${id5} must not be in selector_id ${s1}`);
        const n5 = yield deep.select({
            item_id: { _eq: id5 }, selector_id: { _eq: s2 },
        }, { table: 'selectors', returning: 'item_id selector_id' });
        chai_1.assert.lengthOf(n5 === null || n5 === void 0 ? void 0 : n5.data, 1, `item_id ${id5} must be in selector_id ${s2}`);
    }));
    describe('criteria', () => {
        it(`selector include exclude boolExp`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)((_d = (_c = (_b = (_a = n1 === null || n1 === void 0 ? void 0 : n1.data) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.query) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.exec_bool_exp).to.be.empty;
            ...
            (0, chai_1.expect)((_h = (_g = (_f = (_e = n2 === null || n2 === void 0 ? void 0 : n2.data) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.query) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.exec_bool_exp).to.not.be.empty;
            ...
            (0, chai_1.expect)((_m = (_l = (_k = (_j = n3 === null || n3 === void 0 ? void 0 : n3.data) === null || _j === void 0 ? void 0 : _j[0]) === null || _k === void 0 ? void 0 : _k.query) === null || _l === void 0 ? void 0 : _l[0]) === null || _m === void 0 ? void 0 : _m.exec_bool_exp).to.be.empty;
            ...
            (0, chai_1.expect)((_r = (_q = (_p = (_o = n4 === null || n4 === void 0 ? void 0 : n4.data) === null || _o === void 0 ? void 0 : _o[0]) === null || _p === void 0 ? void 0 : _p.query) === null || _q === void 0 ? void 0 : _q[0]) === null || _r === void 0 ? void 0 : _r.exec_bool_exp).to.not.be.empty;
        }));
    });
});
