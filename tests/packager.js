...
import { Packager, sort } from "../imports/packager";
...
describe('packager', () => {
    describe('class', () => {
        it('export import', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            assert(!((_d = exported.errors) === null || _d === void 0 ? void 0 : _d.length), '!!exported.errors.length');
            const imported = yield packager.import(exported);
            assert(!((_e = imported.errors) === null || _e === void 0 ? void 0 : _e.length), '!!imported.errors.length');
    ...
    describe('sorting', () => {
        ...
        it.skip('strict mode: no sorting', () => {
            ...
            const pckg = { package: { name: 'test' }, data, strict: true };
    ...
    if (GIST_URL) {
        ...
        describe('core', () => {
            it(`install then publish old`, () => __awaiter(void 0, void 0, void 0, function* () {
                var _a, _b;
                const imported = yield packagerInstallCore([], GIST_URL);
                if ((_a = imported.errors) === null || _a === void 0 ? void 0 : _a.length) {
                    log(JSON.stringify(imported, null, 2));
                    throw new Error('!!errors?.length');
                }
                const exported = yield packagerPublishCore([], GIST_URL, imported.packageId);
            ...
            it(`install then publish new`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const exported = yield packagerPublishCore([], address, imported.packageId);
