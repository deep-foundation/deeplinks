...
describe('selectors', () => {
  it(`selector include exclude`, async () => {
    ...
    const n1 = await deep.select({
      item_id: { _eq: id2 }, selector_id: { _eq: s1 }, user_upper_id: { _eq: id2 }
