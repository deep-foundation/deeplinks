...
const generateEnvs = (options) => {
  ...
  if (isGitpod) {
    ...
    envs['HASURA_DEEPLINKS_URL'] = envs['HASURA_DEEPLINKS_URL'] ? envs['HASURA_DEEPLINKS_URL'] : `http://host.docker.internal:${deeplinksPort}`;
  }
