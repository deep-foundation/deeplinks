...
const generateEnvs = (envs) => {
  let envsString = '';
  const customEnvs =[];
  customEnvs['npm_config_yes'] = 'true';
  customEnvs['NEXT_PUBLIC_HIDEPATH'] = '1';
  customEnvs['JWT_SECRET'] = `'{"type":"HS256","key":"3EK6FD+o0+c7tzBNVfjpMkNDi2yARAAKzQlk8O2IKoxQu4nF7EdAh8s3TwpHwrdWT6R"}'`;
  customEnvs['MIGRATIONS_ID_TYPE_SQL'] = 'bigint';
  customEnvs['MIGRATIONS_ID_TYPE_GQL'] = 'bigint';
  customEnvs['MIGRATIONS_HASURA_PATH'] = 'localhost:8080';
  customEnvs['MIGRATIONS_HASURA_SSL'] = '0';
  customEnvs['MIGRATIONS_HASURA_SECRET'] = 'myadminsecretkey';
  customEnvs['NEXT_PUBLIC_DEEPLINKS_SERVER'] = 'http://localhost:3007';
  customEnvs['NEXT_PUBLIC_HASURA_PATH'] = 'localhost:8080';
  customEnvs['NEXT_PUBLIC_HASURA_SSL'] = '0';
  customEnvs['HASURA_PATH'] = 'localhost:8080';
  customEnvs['HASURA_SSL'] = '0';
  customEnvs['MIGRATIONS_DEEPLINKS_APP_URL'] = 'http://host.docker.internal:3007';
  customEnvs['DEEPLINKS_URL'] = 'http://host.docker.internal:3006';
  customEnvs['NEXT_PUBLIC_DEEPLINKS_URL'] = 'http://localhost:3006';
  Object.keys(envs).forEach(k => envsString += handleEnv(k, envs));
  Object.keys(customEnvs).forEach(k => envsString += handleEnv(k, customEnvs));
