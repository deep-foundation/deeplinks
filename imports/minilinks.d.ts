...
export declare function useMinilinksFilter<L extends Link<number>, R = any>(ml: any, filter: (currentLink: L, oldLink: L, newLink: L) => boolean, results: (l: L, ml: any, oldLink: L, newLink: L) => R): R;
