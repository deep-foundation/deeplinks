...
import { GLOBAL_ID_ACTION, GLOBAL_ID_CONTAIN, GLOBAL_ID_OBJECT, GLOBAL_ID_PACKAGE, GLOBAL_ID_PACKAGE_NAMESPACE, GLOBAL_ID_PACKAGE_ACTIVE, GLOBAL_ID_RULE, GLOBAL_ID_SELECTION, GLOBAL_ID_SELECTOR, GLOBAL_ID_SUBJECT, GLOBAL_ID_TYPE, GLOBAL_ID_USER, GLOBAL_ID_PROMISE, GLOBAL_ID_THEN, GLOBAL_ID_REJECTED, GLOBAL_ID_RESOLVED, GLOBAL_ID_PACKAGE_VERSION } from "./global-ids";
...
export const generatePermissionWhere = (actionId: number, _or = []) => {
  return {
    _and: [
      {
        _or: [
          { type_id: { _in: [GLOBAL_ID_USER, GLOBAL_ID_TYPE, GLOBAL_ID_PACKAGE, GLOBAL_ID_PACKAGE_ACTIVE, , GLOBAL_ID_PACKAGE_VERSION, GLOBAL_ID_PACKAGE_NAMESPACE, GLOBAL_ID_PROMISE, GLOBAL_ID_THEN, GLOBAL_ID_REJECTED, GLOBAL_ID_RESOLVED] } },
