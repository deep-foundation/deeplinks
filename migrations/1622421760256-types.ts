...
export const up = async () => {
  ...
  const mutateResult = await client.mutate(generateSerial({
    actions: [
      ...
      insertMutation(LINKS_TABLE_NAME, { objects: { /*id: 31,*/ type_id: 6, from_id: 0, to_id: 0 } }),
      insertMutation(LINKS_TABLE_NAME, { objects: { /*id: 32,*/ type_id: 6, from_id: 0, to_id: 0 } }),

      insertMutation(LINKS_TABLE_NAME, { objects: { /*id: 33,*/ type_id: 1, from_id: 0, to_id: 0 } }),
      insertMutation(STRING_TABLE_NAME, { objects: { link_id: 33, value: 'package' }, }),
