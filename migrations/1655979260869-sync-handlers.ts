...
const handleUpdateTypeId = 50; // await deep.id('@deep-foundation/core', 'HandleUpdate');
const handleDeleteTypeId = 51; // await deep.id('@deep-foundation/core', 'HandleDelete');
