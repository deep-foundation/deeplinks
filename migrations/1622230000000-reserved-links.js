...
export const upTable = ({ SCHEMA = DEFAULT_SCHEMA, RL_TABLE = DEFAULT_RL_TABLE, DATE_TYPE = DEFAULT_DATE_TYPE_SQL, customColumns = '' } = {}) => __awaiter(void 0, void 0, void 0, function* () {
    yield api.sql(sql `
...
export const downTable = ({ SCHEMA = DEFAULT_SCHEMA, RL_TABLE = DEFAULT_RL_TABLE } = {}) => __awaiter(void 0, void 0, void 0, function* () {
    yield api.query({
        type: 'untrack_table',
        args: {
            table: {
...
export const up = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    log('trigger');
    yield api.sql(sql `CREATE OR REPLACE FUNCTION ${LINKS_TABLE_NAME}__reserved__instead_of_insert__function() RETURNS TRIGGER AS $trigger$
    BEGIN
...
//# sourceMappingURL=1622230000000-reserved-links.js.map